	...
	<head>
		...
		<script type="text/javascript">
			...
			function q_gfPost() {
				...
				q_cmbParse("cmbXaccno", "@全部,Y@已立帳,N@未立帳");
				$('#txtNoa').focus();
			}
			...
			function q_seekStr() {
                ...
                if(t_status=='N')
                	t_where += " and unpay!=0";
                if(t_xaccno=='Y')
                	t_where += " and isnull(accno,'')!='' and total!=0 ";
                if(t_xaccno=='N')
                	t_where += " and isnull(accno,'')='' and total!=0 ";
	...
	>
		<div style="width:95%; text-align:center;padding:15px;" >
			<table id="seek" border="1" cellpadding="3" cellspacing="2" style="width:100%;">
				...
				<tr class='seek_tr'>
	                <td class='seek'  style="width:20%;"><a id='lblXaccno'>傳票立帳</a></td>
	                <td><select id="cmbXaccno" class="txt c1" style="font-size:medium;"> </select></td>
	             </tr>
			</table>
